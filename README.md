...
<img src="https://raw.githubusercontent.com/adearya/freecodecamp-personal-portfolio-webpage/HEAD/raw/images/github_user_logo.jpeg" alt="Github User Logo" width="80" height="80">

<h3 align="center">Personal Portfolio Webpage - By freeCodeCamp</h3>
    <p align="center">
        I created this project as part of a freeCodeCamp certification, focusing on structured content presentation and modern portfolio design.
    </p>
</div>
...
![App Screenshot](https://raw.githubusercontent.com/adearya/freecodecamp-personal-portfolio-webpage/HEAD/raw/images/desktop_screenshot.png)

<p align="center">
    This project was developed using TailwindCSS to ensure a clean, modern, and user-friendly design. It includes sections for personal information, project showcases, and contact details, structured for easy navigation.
</p>
...
<p>
    Users can explore a well-organized portfolio showcasing projects and skills in a visually appealing and responsive format. The layout ensures a smooth browsing experience on various devices.
</p>
...
Clone the repo
```sh
git clone https://github.com/adearya/freecodecamp-personal-portfolio-webpage.git
```
Change directory
```sh
cd freecodecamp-personal-portfolio-webpage/
```
<!-- add_installation -->
